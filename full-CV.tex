...
\item[] Likit Preeyanon (MMG PhD student, 2008-2014 (expected)
\item[] Qingpeng Zhang (CSE PhD student, 2008-2014 (expected))
\item[] CS Welcher (CSE PhD student, 2012-2017 (expected))
\end{list1}
...
\item[] Kanchan Pavangadkar (now student advisor at MSU)
\end{list1}
